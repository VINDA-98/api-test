...
func main() {
	...
	r.GET("/members", func(c *gin.Context) {
		departments, members := GetDepartment100()
		// c.JSON：返回JSON格式的数据
		c.JSON(200, gin.H{
			"members":     members,
...
func GetDepartment1000() (departments []Department, members []Member) {
...
func GetDepartment100() (departments []Department, members []Member) {
